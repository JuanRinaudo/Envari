...
em++ -IEnvari\LUA\include Envari\source\RuntimeWASM.cpp Envari\LUA\include\liblua.a -g4 ^
    ...
    -std=c++17 ^
    --preload-file data/fonts@fonts ^
    --preload-file data/images@images ^
    --preload-file data/scripts@scripts ^
    --preload-file data/shaders@shaders ^
    --preload-file data/data@data ^
    --preload-file data/atlas@atlas ^
    --preload-file data/sound@sound ^
