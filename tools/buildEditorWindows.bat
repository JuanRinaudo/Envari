...
@REM if not exist mime.dll copy ..\..\Envari\LUA\lib\x64\mime.dll mime.dll >NUL
@REM if not exist socket.dll copy ..\..\Envari\LUA\lib\x64\socket.dll socket.dll >NUL
...
cl ..\..\Envari\source\EditorWindows.cpp LUAScriptingBindings.obj -FmEditorWindows.map %CommonCompilerFlags% -Bt -I ..\..\Envari\SDL2\include -I ..\..\Envari\Optick\include -I ..\..\Envari\LUA\include -link %CommonLinkerFlags% -LIBPATH:"..\..\Envari\SDL2\lib\x64" -LIBPATH:"..\..\Envari\Optick\lib\x64\release" -LIBPATH:"..\..\Envari\LUA\lib\x64" -PDB:EditorWindows.pdb
@echo End time %time%
