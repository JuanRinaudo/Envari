...
REM cl -MD %CommonCompilerFlags% ..\..\Envari\Envari\source\EnvariWindows.cpp -FmEnvari.map /EHsc /I ..\..\Envari\GLFW\include /I ..\..\Envari\LUAJIT\include /std:c++17 /link /LIBPATH:"..\..\Envari\GLFW\x32\lib-vc2019" /LIBPATH:"..\..\Envari\LUAJIT\lib\x86" %CommonLinkerFlags% /PDB:Envari_%random%.pdb
